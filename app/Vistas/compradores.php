                    ...
                    <div class="container-fluid d-flex flex-column vh-100">
                        <div class="row">
                            <div class="col-md-12 mt-md-5 mt-lg-4 pt-md-2 pt-lg-0">
                                <div class="card">
                                    <div class="card-body">
                                        <h2 class="text-primary">SOLICITUDES ACTIVAS</h2>
                                        <div class="mb-3 bg-light col-md-12">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6">
                                                    <button class="btn btn-primary" type="button" onclick="modalVerTarjetas()">TARJETAS</button>
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-6">
                                                    <button class="btn btn-primary" type="button" onclick="modalAgendarPedido()"><i class="bi bi-calendar-plus"> AGENDAR</i></button>
                                                </div>
                                            </div>
                                        </div>
...
-->
    ...
    include './Modales/VisualizarTarjetas.php';
    include './Modales/EliminarProveedor.php';
    include './Modales/ModalEliminacion.php';
    include './Modales/VisualizarMotivos.php';
    include './Modales/AgregarTarjeta.php';
    include './Modales/EditarTarjeta.php';
    include './Modales/visualizacionimagenes.php';
