...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/tarjetasSombreadas.css" />
                    ...
                    <div class="container-fluid d-flex flex-column vh-100">
                        <div class="row">
                            <div class="col-md-12 mt-md-5 mt-lg-4 pt-md-2 pt-lg-0">
                                <div class="card">
                                    <div class="card-body">
                                    <h2 class="text-primary">SOLICITUDES</h2>

                                    <div class="mb-3 bg-light col-md-12 rounded ">
                                            <div class="row align-items-center">
                                                <div class="col-lg-3 col-md-6 col-sm-6">
                                                <p class="p-2"> Fecha de inicio: <input type="date" class="form-control" name="fecha_inicio"></p>
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-6">
                                                <p class="p-2"> Fecha de fin: <input type="date" class="form-control" name="fecha_fin"> </p>
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-6">
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-6">
                                               <button class="btn btn-primary p-2" type="button"> <i class="bi bi-file-earmark-pdf-fill">Descargar</i></button>
                                                </div>
                                            </div>
                                        </div>
...
include './Modales/AnexarEvidencias.php';
include './Modales/AnexarEvidencias.php';
